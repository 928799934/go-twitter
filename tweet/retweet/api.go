...
const (
	listUsersEndpoint = gotwitter.Domain + "/2/tweets/:id/retweeted_by"
	createEndpoint    = gotwitter.Domain + "/2/users/:id/retweets"
	deleteEndpoint    = gotwitter.Domain + "/2/users/:id/retweets/:source_tweet_id"
)
